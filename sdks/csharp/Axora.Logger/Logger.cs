...
public sealed class Logger
{
    ...
    {
        var resolved = !string.IsNullOrWhiteSpace(candidate) ? candidate : Environment.GetEnvironmentVariable("AXORA_SERVICE");
    ...
    {
        var resolved = !string.IsNullOrWhiteSpace(candidate) ? candidate : Environment.GetEnvironmentVariable("AXORA_ENV");
