...
impl DocIndex {
    ...
    fn remove_from_keyword_index(&mut self, doc_id: &str) {
        ...
        let keywords_to_remove: Vec<String> = self.keyword_index
            .iter()
...
mod tests {
    ...
    fn test_doc_index_search_with_filters() {
        ...
        index.add(create_test_doc("doc1", "auth", "authentication token jwt")).expect("Failed");
        index.add(create_test_doc("doc2", "auth", "user login session")).expect("Failed");
        index.add(create_test_doc("doc3", "cache", "redis cache storage")).expect("Failed");
        ...
        assert!(results.iter().all(|r| {
            index.get(&r.doc_id).unwrap().schema.module == "auth"
        }));
    }
    ...
    fn test_doc_index_update() {
        ...
        let mut updated_doc = create_test_doc("test-doc", "auth", "updated content with new keywords");
    ...
    fn test_doc_index_remove() {
        ...
        index.add(create_test_doc("doc1", "auth", "content 1")).expect("Failed");
        index.add(create_test_doc("doc2", "cache", "content 2")).expect("Failed");
    ...
    fn test_doc_index_by_module() {
        ...
        index.add(create_test_doc("auth1", "auth", "auth content")).expect("Failed");
        index.add(create_test_doc("auth2", "auth", "more auth")).expect("Failed");
        index.add(create_test_doc("cache1", "cache", "cache content")).expect("Failed");
    ...
    fn test_doc_staleness_detection() {
        ...
        // Add a document
        index.add(create_test_doc("fresh-doc", "auth", "fresh content")).expect("Failed");
    ...
    fn test_doc_index_empty_queries() {
        ...
        index.add(create_test_doc("doc1", "auth", "content")).expect("Failed");
