use openakta_agents::agent::{Agent, TaskResult};
use openakta_agents::task::{Task, TaskStatus};
use openakta_agents::worker_pool::{WorkerPool, WorkerPoolConfig, WorkerStatus};
...
impl Agent for CountingAgent {
    ...
    fn execute(&mut self, task: Task) -> openakta_agents::Result<TaskResult> {
        Ok(TaskResult {
            success: true,
...
fn auto_restart_replaces_failed_worker_state() {
...

    {
        ...
        worker.lifecycle = openakta_agents::WorkerLifecycle::Failed;
    }
