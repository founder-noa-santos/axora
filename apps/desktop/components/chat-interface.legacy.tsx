          ...
          <div className="w-full flex flex-col items-center text-center px-6 pt-32">
            <div className="w-full max-w-3xl">
              ...
              <div className="relative inline-block mb-12" data-dropdown>
                ...
                {projectOpen && (
                  <div
                    className="absolute top-full left-0 mt-1 bg-panel/95 backdrop-blur-xl border border-border/60 rounded-lg shadow-lg py-1 z-50 min-w-[200px]"
                    data-dropdown
                  >
            ...
            <div className="flex items-center justify-between px-1 pt-1 mt-1">
              <div className="flex items-center gap-1.5">
                ...
                <div className="relative" data-dropdown>
                  ...
                  {modelOpen && (
                    <div
                      className="absolute bottom-full left-0 mb-1 bg-panel/95 backdrop-blur-xl border border-border/60 rounded-lg shadow-lg py-1 z-50 min-w-[180px]"
                      data-dropdown
                    >
                ...
                <div className="relative" data-dropdown>
                  ...
                  {effortOpen && (
                    <div
                      className="absolute bottom-full left-0 mb-1 bg-panel/95 backdrop-blur-xl border border-border/60 rounded-lg shadow-lg py-1 z-50 min-w-[140px]"
                      data-dropdown
                    >
          ...
          <div className="flex items-center justify-between px-2 mt-3 text-[11px] font-medium text-muted-foreground">
            <div className="flex items-center gap-4">
              ...
              <div className="relative" data-dropdown>
                ...
                {accessOpen && (
                  <div
                    className="absolute bottom-full left-0 mb-1 bg-panel/95 backdrop-blur-xl border border-border/60 rounded-lg shadow-lg py-1 z-50 min-w-[160px]"
                    data-dropdown
                  >
                    {[
            ...
            <div className="relative" data-dropdown>
              ...
              {branchOpen && (
                <div
                  className="absolute bottom-full right-0 mb-1 bg-panel/95 backdrop-blur-xl border border-border/60 rounded-lg shadow-lg py-1 z-50 min-w-[140px]"
                  data-dropdown
                >
